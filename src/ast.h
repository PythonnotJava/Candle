...
struct AstNode {
    ...
    union {
        ...
        struct {
            ...
            int is_static;
            int is_final;
            int is_func_type;       // function pointer type param
            NodeList func_type_params; // inner params for func type
        } var;
        ...
        struct {
            char *class_name;
            NodeList params;
            AstNode *body;      // nullable: ??????this.field=... ??
        } constructor;
        ...
        struct {
            AstNode *body;
            NodeList catch_types;   // identifiers (type names), ???? NULL ??? catch(e)
            NodeList catch_names;   // identifiers (var names)
            NodeList catch_bodies;  // blocks
            AstNode *finally_block; // nullable: final { ... } ??????
        } try_stmt;
